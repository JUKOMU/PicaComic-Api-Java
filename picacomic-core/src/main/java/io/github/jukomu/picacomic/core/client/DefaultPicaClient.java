...
import io.github.jukomu.picacomic.core.net.ImageLocatorResolver;
import io.github.jukomu.picacomic.core.net.OkHttpBuilder;
import io.github.jukomu.picacomic.core.net.OkHttpPicaImageRequest;
 ...
 */
public final class DefaultPicaClient implements IPicaClient {
    ...
    @FunctionalInterface
    public interface ImageFileMover {
        /**
         * 将临时文件移动到最终目标路径。
         *
    ...
    public DefaultPicaClient(PicaConfiguration config, OkHttpBuilder.HttpClientContext context) {
        this(config, context, DefaultPicaClient::writeImageFile, FileUtils::moveAtomically,
                () -> { }, () -> { }, System::nanoTime);
    }

    public DefaultPicaClient(PicaConfiguration config,
