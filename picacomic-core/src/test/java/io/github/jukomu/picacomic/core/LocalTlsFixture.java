...
final class LocalTlsFixture implements AutoCloseable {
    ...
    LocalTlsFixture() throws IOException {
        HeldCertificate certificate = new HeldCertificate.Builder()
                ...
                .addSubjectAlternativeName("api-three.test")
                .addSubjectAlternativeName("unknown.test")
                .addSubjectAlternativeName("image-one.test")
                .addSubjectAlternativeName("image-two.test")
                .addSubjectAlternativeName("redirect.test")
                .addSubjectAlternativeName("untrusted.test")
                .addSubjectAlternativeName("picaapi.picacomic.com")
